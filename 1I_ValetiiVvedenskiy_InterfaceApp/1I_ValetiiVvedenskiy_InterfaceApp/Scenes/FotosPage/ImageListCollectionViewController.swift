...
class ImageListCollectionViewController: UICollectionViewController, UINavigationControllerDelegate {
  ...
  func loadPhotosFromRealm() {
    DispatchQueue.main.async { [weak self] in
      ...
      let rPhotos = Array(self.photosFromRealm)
      self.collectionPhotos = rPhotos.map { model -> Photo in
        Photo(
          photo: model.photo.loadImage(),
  ...
  override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    ...
    cell.setUpCell(url: collectionPhotos[indexPath.row].photo)
  ...
  override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
    ...
    vc.imgArray = collectionPhotos
    vc.passedContentOffset = indexPath
    vc.imageCell = UIImageView(frame: collectionView.layer.bounds)
    vc.imageCell.kf.setImage(with: collectionPhotos[indexPath.row].photo)
